...
execute if score @s kb.anime_time matches 50 run function kboss:system/boss/each/platypus/pose/jump/left/2
...
execute if score @s kb.anime_time matches 15 run function kboss:system/boss/each/platypus/pose/jump/left/3
...
execute if score @s kb.anime_time matches ..0 run function kboss:system/boss/each/platypus/action/101/1to2
