...
# 17:突進
execute if score @s kb.temp matches 4..9 run function kboss:system/boss/each/martellos/action/change/17
# 18:小突く
#execute if score @s kb.temp matches 12..13 run function kboss:system/boss/each/martellos/action/change/18
# 19:回転土飛ばし(右)
execute if score @s kb.temp matches 10..12 run function kboss:system/boss/each/martellos/action/change/19
# 20:回転土飛ばし(左)
execute if score @s kb.temp matches 13..15 run function kboss:system/boss/each/martellos/action/change/20
