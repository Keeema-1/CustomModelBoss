...
execute if data storage kboss:temp {direction:{leftside:0b}} if entity @a[tag=KB.SameArea,distance=..32] run function kboss:system/boss/each/martellos/action/each/2/to3
