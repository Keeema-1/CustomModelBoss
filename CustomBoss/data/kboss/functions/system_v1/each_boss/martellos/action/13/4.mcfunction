...
execute run function kboss:system/each_boss/martellos/action/common/space/left
...
execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/martellos/action/13/4to5
