...
execute if entity @s[tag=KB.Matsuri] run scoreboard players set @s kb.temp2 9
execute if entity @s[tag=KB.Mantis] run scoreboard players set @s kb.temp2 17
...
#execute if entity @s[tag=KB.Matsuri] run scoreboard players remove $system kb.health 0
