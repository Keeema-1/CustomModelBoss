...
execute if entity @s[tag=KB.Mantis] run function kboss:system/each_boss/mantis/action_change/99
execute if entity @s[tag=!KB.Matsuri,tag=!KB.BigSquirrel,tag=!KB.Platypus,tag=!KB.Martellos,tag=!KB.Mantis] run kill @e[tag=KB.BossCheck]
