...
execute if entity @s[tag=!KB.Dead] run function kboss:system/each_boss/general/sub
execute if entity @s[tag=KB.Dead] run function kboss:system/each_boss/general/dead
