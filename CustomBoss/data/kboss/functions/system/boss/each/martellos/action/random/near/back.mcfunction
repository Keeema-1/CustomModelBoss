...
# 12:タックル(右)
execute if score @s kb.temp matches 6 run function kboss:system/boss/each/martellos/action/each/12/start
# 13:タックル(左)
execute if score @s kb.temp matches 7 run function kboss:system/boss/each/martellos/action/each/13/start
# 14:回転(右)
execute if score @s kb.temp matches 8..9 run function kboss:system/boss/each/martellos/action/each/14/start
# 15:回転(左)
execute if score @s kb.temp matches 10..11 run function kboss:system/boss/each/martellos/action/each/15/start
# 16:揺らす
...
# 19:回転土飛ばし(右)
execute if score @s kb.temp matches 12 run function kboss:system/boss/each/martellos/action/each/19/start
# 20:回転土飛ばし(左)
execute if score @s kb.temp matches 13 run function kboss:system/boss/each/martellos/action/each/20/start
# 26:振り向き左叩き
execute if score @s kb.temp matches 14 run function kboss:system/boss/each/martellos/action/each/26/start
# 27:振り向き右叩き
execute if score @s kb.temp matches 15 run function kboss:system/boss/each/martellos/action/each/27/start
