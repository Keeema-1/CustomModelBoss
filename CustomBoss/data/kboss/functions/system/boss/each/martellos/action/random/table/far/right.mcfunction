...
# 7:叩く(右)
execute if score @s kb.temp matches ..1 run function kboss:system/boss/each/martellos/action/each/7/start
# 8:叩く(左)
...
# 12:タックル(右)
execute if score @s kb.temp matches 2..5 run function kboss:system/boss/each/martellos/action/each/12/start
# 13:タックル(左)
#execute if score @s kb.temp matches 2..5 run function kboss:system/boss/each/martellos/action/each/13/start
# 14:回転(右)
execute if score @s kb.temp matches 6..7 run function kboss:system/boss/each/martellos/action/each/14/start
# 15:回転(左)
#execute if score @s kb.temp matches 6..7 run function kboss:system/boss/each/martellos/action/each/15/start
# 16:揺らす
#execute if score @s kb.temp matches 9..10 run function kboss:system/boss/each/martellos/action/each/16/start
# 17:突進
execute if score @s kb.temp matches 8..11 run function kboss:system/boss/each/martellos/action/each/17/start
# 18:小突く
#execute if score @s kb.temp matches 12..13 run function kboss:system/boss/each/martellos/action/each/1/start8
# 19:回転土飛ばし(右)
execute if score @s kb.temp matches 12..15 run function kboss:system/boss/each/martellos/action/each/19/start
# 20:回転土飛ばし(左)
