...
# 7:叩く(右)
execute if score @s kb.temp matches ..3 run function kboss:system/boss/each/martellos/action/change/7
# 8:叩く(左)
...
# 12:タックル(右)
execute if score @s kb.temp matches 5..8 run function kboss:system/boss/each/martellos/action/change/12
# 13:タックル(左)
#execute if score @s kb.temp matches 5..8 run function kboss:system/boss/each/martellos/action/change/13
# 14:回転(右)
execute if score @s kb.temp matches 9..10 run function kboss:system/boss/each/martellos/action/change/14
# 15:回転(左)
#execute if score @s kb.temp matches 9..10 run function kboss:system/boss/each/martellos/action/change/15
# 16:揺らす
execute if score @s kb.temp matches 11..12 run function kboss:system/boss/each/martellos/action/change/16
# 17:突進
execute if score @s kb.temp matches 13 run function kboss:system/boss/each/martellos/action/change/17
# 18:小突く
#execute if score @s kb.temp matches 13 run function kboss:system/boss/each/martellos/action/change/18
# 19:回転土飛ばし(右)
execute if score @s kb.temp matches 14..15 run function kboss:system/boss/each/martellos/action/change/19
# 20:回転土飛ばし(左)
#execute if score @s kb.temp matches 14..15 run function kboss:system/boss/each/martellos/action/change/20
