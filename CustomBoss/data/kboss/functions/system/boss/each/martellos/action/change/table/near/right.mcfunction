...
# 7:叩く(右)
execute if score @s kb.temp matches ..4 run function kboss:system/boss/each/martellos/action/change/7
# 8:叩く(左)
#execute if score @s kb.temp matches ..3 run function kboss:system/boss/each/martellos/action/change/8
# 9:叩く(尻尾)
execute if score @s kb.temp matches 5 run function kboss:system/boss/each/martellos/action/change/9
# 10:ステップ(右)
...
# 12:タックル(右)
execute if score @s kb.temp matches 6..9 run function kboss:system/boss/each/martellos/action/change/12
# 13:タックル(左)
...
# 15:回転(左)
execute if score @s kb.temp matches 12 run function kboss:system/boss/each/martellos/action/change/15
# 16:揺らす
