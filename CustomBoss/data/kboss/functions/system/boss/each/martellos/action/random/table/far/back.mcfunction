...
# 14:回転(右)
execute if score @s kb.temp matches 8 run function kboss:system/boss/each/martellos/action/each/14/start
# 15:回転(左)
execute if score @s kb.temp matches 9 run function kboss:system/boss/each/martellos/action/each/15/start
# 16:揺らす
...
# 20:回転土飛ばし(左)
execute if score @s kb.temp matches 13..15 run function kboss:system/boss/each/martellos/action/each/20/start
