...
function kboss:system/boss/each/matsuri/action/common/ypos/main
...
execute if score @s kb.action_time matches ..0 run function kboss:system/boss/each/martellos/action/each/99/1to2
