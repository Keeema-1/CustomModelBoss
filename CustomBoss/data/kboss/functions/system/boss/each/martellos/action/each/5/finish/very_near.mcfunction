...
# 21:ステップ(後)
execute if score @s kb.temp matches 2..3 run function kboss:system/boss/each/martellos/action/change/21
# 22:ステップ(後)
execute if score @s kb.temp matches 4..5 run function kboss:system/boss/each/martellos/action/change/22

# 他のアクション
execute if score @s kb.temp matches 6.. run function kboss:system/boss/each/martellos/action/change/table/main
