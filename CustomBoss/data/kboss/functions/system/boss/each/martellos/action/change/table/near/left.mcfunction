...
# 8:叩く(左)
execute if score @s kb.temp matches ..4 run function kboss:system/boss/each/martellos/action/change/8
# 9:叩く(尻尾)
...
# 13:タックル(左)
execute if score @s kb.temp matches 6..9 run function kboss:system/boss/each/martellos/action/change/13
# 14:回転(右)
execute if score @s kb.temp matches 10 run function kboss:system/boss/each/martellos/action/change/14
# 15:回転(左)
execute if score @s kb.temp matches 11..12 run function kboss:system/boss/each/martellos/action/change/15
# 16:揺らす
