...
function kboss:system/boss/each/martellos/pose/rotate/left/2
...
tag @e[distance=..16,tag=KB.Tail,tag=KB.AI,tag=KB.BossCheck] add KB.ReachAdd1
tag @e[distance=..16,tag=KB.Tail,tag=KB.AI,tag=KB.BossCheck] add KB.Attack
