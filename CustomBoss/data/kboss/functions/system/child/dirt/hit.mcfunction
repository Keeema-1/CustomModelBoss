...
tp @e[tag=KB.Bullet,tag=KB.Dirt,sort=nearest,limit=1] ~ ~-3 ~
kill @s
execute positioned ~ ~-3 ~ run data merge entity @e[tag=KB.Bullet,tag=KB.Dirt,sort=nearest,limit=1] {Size:0,Health:0.0f}
