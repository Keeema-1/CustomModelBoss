...
scoreboard players set @e[tag=KB.Skin,tag=KB.RightArm1,tag=KB.BossCheck] kb.drx 60
scoreboard players set @e[tag=KB.Skin,tag=KB.RightArm1,tag=KB.BossCheck] kb.dry 60
