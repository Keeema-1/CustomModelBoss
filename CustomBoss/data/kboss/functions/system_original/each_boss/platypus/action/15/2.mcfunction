...
execute if data storage kboss:temp {space:1b} if score @s kb.action_time matches 16..20 run tp ^ ^ ^-0.5
execute if data storage kboss:temp {space:1b} if score @s kb.action_time matches 11..15 run tp ^ ^ ^-0.25

execute at @s run function kboss:system/each_boss/platypus/action/common/ypos/main

execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/platypus/action/15/2to3
