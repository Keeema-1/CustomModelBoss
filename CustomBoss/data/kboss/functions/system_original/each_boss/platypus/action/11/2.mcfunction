...
execute if data storage kboss:temp {space:1b} if score @s kb.action_time matches 16..25 run tp ^ ^ ^0.5
...
execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/platypus/action/11/finish
