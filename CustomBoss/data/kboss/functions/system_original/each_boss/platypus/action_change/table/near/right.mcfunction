...
# 7:噛みつき(右)
execute if score @s kb.temp matches 2..5 run function kboss:system/each_boss/platypus/action_change/7
# 8:ダイブ
...
# 10:タックル(右)
execute if score @s kb.temp matches 7..10 run function kboss:system/each_boss/platypus/action_change/10
# 11:尻尾(左)
#execute if score @s kb.temp matches 11..13 run function kboss:system/each_boss/platypus/action_change/11
# 12:強尻尾(左)
#execute if score @s kb.temp matches 14..15 run function kboss:system/each_boss/platypus/action_change/12
# 11:尻尾(右)
execute if score @s kb.temp matches 11..12 run function kboss:system/each_boss/platypus/action_change/13
# 12:強尻尾(右)
execute if score @s kb.temp matches 13..14 run function kboss:system/each_boss/platypus/action_change/14
# 15:尻尾(後)
