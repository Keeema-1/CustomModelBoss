...
# 9:タックル(左)
execute if score @s kb.temp matches 8 run function kboss:system/each_boss/platypus/action_change/9
# 10:タックル(右)
#execute if score @s kb.temp matches 9 run function kboss:system/each_boss/platypus/action_change/10
# 11:尻尾(左)
execute if score @s kb.temp matches 9 run function kboss:system/each_boss/platypus/action_change/11
# 12:強尻尾(左)
execute if score @s kb.temp matches 10..12 run function kboss:system/each_boss/platypus/action_change/12
# 11:尻尾(右)
