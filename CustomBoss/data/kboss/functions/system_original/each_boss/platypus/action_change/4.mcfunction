...
function kboss:system/each_boss/platypus/pose/bark/1
...
execute if entity @s[tag=!KB.Noticed] as @a[tag=KB.SameArea] at @s run function map:system/each_player/music/3/set
