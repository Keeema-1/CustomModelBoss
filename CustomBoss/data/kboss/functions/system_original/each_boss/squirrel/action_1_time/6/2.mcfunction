...
function kboss:system/each_boss/squirrel/action/common/space/left
...
execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/squirrel/action/6/finish
