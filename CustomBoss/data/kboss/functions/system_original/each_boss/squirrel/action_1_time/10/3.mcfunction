...
execute if data storage kboss:temp {space:1b} rotated ~ 0 run tp ^ ^ ^0.5
...
execute if data storage kboss:temp {check:1b} run tp ~ ~-0.1 ~
execute if data storage kboss:temp {check:1b} at @s if block ~-1 ~-0.21 ~-1 #kboss:space if block ~-1 ~-0.21 ~ #kboss:space if block ~-1 ~-0.21 ~1 #kboss:space if block ~ ~-0.21 ~-1 #kboss:space if block ~ ~-0.21 ~ #kboss:space if block ~ ~-0.21 ~1 #kboss:space if block ~1 ~-0.21 ~-1 #kboss:space if block ~1 ~-0.21 ~ #kboss:space if block ~1 ~-0.21 ~1 #kboss:space run tp ~ ~-0.2 ~
