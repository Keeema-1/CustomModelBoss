...
# 4:噛みつき(左)
execute if score @s kb.temp matches 2..5 run function kboss:system/each_boss/squirrel/action_change/4
# 5:タックル(右)
#execute if score @s kb.temp matches 6..10 run function kboss:system/each_boss/squirrel/action_change/5
# 6:タックル(左)
execute if score @s kb.temp matches 6..10 run function kboss:system/each_boss/squirrel/action_change/6
# 7:回転
