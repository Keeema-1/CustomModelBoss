...
# 6:タックル(左)
# 7:回転
execute if score @s kb.temp matches 7..10 run function kboss:system/each_boss/squirrel/action_change/7
# 9:尻尾振り
execute if score @s kb.temp matches 11..15 run function kboss:system/each_boss/squirrel/action_change/9
# 10:ジャンプ
