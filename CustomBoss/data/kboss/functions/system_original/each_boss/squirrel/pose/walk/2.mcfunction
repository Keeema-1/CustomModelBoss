...
data modify storage kboss:temp temp set from storage kboss:pose squirrel.walk.2

scoreboard players set @e[tag=KB.Skin,tag=KB.BossCheck] kb.drx 2
scoreboard players set @e[tag=KB.Skin,tag=KB.Leg,tag=KB.BossCheck] kb.drx 10
