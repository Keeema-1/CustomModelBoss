...
# 13: 疲労
execute if score @s kb.action matches 13 run function kboss:system/each_boss/squirrel/action/13/main
...
# 101:ムービー
execute if score @s kb.action matches 101 run function kboss:system/each_boss/squirrel/action/101/main

# test
execute if score @s kb.action matches 102 run function kboss:system/each_boss/squirrel/action/102/main
