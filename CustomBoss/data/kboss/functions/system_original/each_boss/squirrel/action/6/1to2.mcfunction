...
function kboss:system/each_boss/squirrel/pose/tackle/left/2
...
tag @e[distance=..16,tag=KB.Body1,tag=KB.AI,tag=KB.BossCheck] add KB.Attack
tag @e[distance=..16,tag=KB.Body2,tag=KB.AI,tag=KB.BossCheck] add KB.Attack
tag @e[distance=..16,tag=KB.Tail1,tag=KB.AI,tag=KB.BossCheck] add KB.Attack
