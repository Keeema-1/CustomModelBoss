...
execute if data storage kboss:temp {direction:{leftside:0b}} run function kboss:system/each_boss/matsuri/action/6/1to2

execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/matsuri/action/6/1to2
