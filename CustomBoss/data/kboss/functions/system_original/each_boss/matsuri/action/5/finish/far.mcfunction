...
# 1:接近
execute if score @s kb.temp matches 0..3 run function kboss:system/each_boss/matsuri/action_change/1
# 10:ステップ(右)
...
# 他のアクション
execute if score @s kb.temp matches 4.. run function kboss:system/each_boss/matsuri/action_change/table/main
