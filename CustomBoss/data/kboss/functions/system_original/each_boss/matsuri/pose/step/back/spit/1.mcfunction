...
data modify storage kboss:temp temp set from storage kboss:pose matsuri.step.back.spit.1

scoreboard players set @e[tag=KB.Skin,tag=KB.BossCheck] kb.drx 8
scoreboard players set @e[tag=KB.Skin,tag=KB.BossCheck] kb.dry 8
