...
function kboss:system/each_boss/matsuri/pose/normal/1

scoreboard players set @s kb.action 0
scoreboard players set @s kb.action_sub 1

scoreboard players set @s kb.action_time 5
execute if predicate kboss:random/500m run scoreboard players add @s kb.action_time 5
execute if predicate kboss:random/500m run scoreboard players add @s kb.action_time 5
