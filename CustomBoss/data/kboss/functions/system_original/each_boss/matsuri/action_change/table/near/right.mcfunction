...
# 7:右パンチ
execute if score @s kb.temp matches 0..2 run function kboss:system/each_boss/matsuri/action_change/7
# 8:左パンチ
execute if score @s kb.temp matches 3 run function kboss:system/each_boss/matsuri/action_change/8
# 9:左回転
