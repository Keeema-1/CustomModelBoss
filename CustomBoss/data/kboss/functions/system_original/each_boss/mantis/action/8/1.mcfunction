...
execute if predicate kboss:random/500m at @e[distance=..16,tag=KB.Head] run particle minecraft:entity_effect ~ ~2 ~ 0 0.5 0 1 0
...
execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/mantis/action/8/1to2
