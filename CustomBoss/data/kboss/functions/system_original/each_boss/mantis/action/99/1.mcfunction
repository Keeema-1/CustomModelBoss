...
function kboss:system/each_boss/mantis/action/common/ypos/main
...
execute if score @s kb.action_time matches ..0 run function kboss:system/each_boss/mantis/action/99/1to2
