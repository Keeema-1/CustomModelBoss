...
execute if score @s kb.action_time matches 50 run function kboss:system/each_boss/mantis/pose/swing/right/3

execute if score @s kb.action_time matches 45 run scoreboard players set @e[distance=..16,tag=KB.Skin,tag=KB.BossCheck] kb.drx 5

execute if score @s kb.action_time matches 20 run function kboss:system/each_boss/mantis/pose/swing/right/1

execute if score @s kb.action_time matches 35 run function kboss:system/each_boss/mantis/action/common/attack_finish
