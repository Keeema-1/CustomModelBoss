...
# 14:上ジャンプ&花火
execute if score @s kb.temp matches 9..10 run function kboss:system/each_boss/matsuri/action_change/14
# 15:走る
...
# 21:バックステップ発射
execute if score @s kb.temp matches 14..15 run function kboss:system/each_boss/matsuri/action_change/21
