...
function kboss:system/each_boss/mantis/pose/swing/right/1
...
execute as @e[distance=..16,tag=KB.AI,tag=KB.BossCheck] run attribute @s generic.attack_knockback base set 4.0
