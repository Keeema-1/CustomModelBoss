...
execute if score @s kb.anime_time matches 160 run function kboss:system/each_boss/platypus/pose/look_around/left/1

execute if score @s kb.anime_time matches 100 run function kboss:system/each_boss/platypus/pose/normal/2

execute if score @s kb.anime_time matches 91..100 run tp @s ~ ~0.05 ~ ~10 ~

execute if score @s kb.anime_time matches 90 run function kboss:system/each_boss/platypus/pose/run/1
execute if score @s kb.anime_time matches 80 run function kboss:system/each_boss/platypus/pose/run/2
execute if score @s kb.anime_time matches 70 run function kboss:system/each_boss/platypus/pose/run/1
execute if score @s kb.anime_time matches 60 run function kboss:system/each_boss/platypus/pose/run/2
execute if score @s kb.anime_time matches 50 run function kboss:system/each_boss/platypus/pose/run/1
execute if score @s kb.anime_time matches 40 run function kboss:system/each_boss/platypus/pose/run/2
execute if score @s kb.anime_time matches 30 run function kboss:system/each_boss/platypus/pose/run/1
execute if score @s kb.anime_time matches 20 run function kboss:system/each_boss/platypus/pose/run/2
execute if score @s kb.anime_time matches 10 run function kboss:system/each_boss/platypus/pose/run/1
...
execute if score @s kb.anime_time matches ..0 run function kboss:system/each_boss/platypus/action/101/3to4
