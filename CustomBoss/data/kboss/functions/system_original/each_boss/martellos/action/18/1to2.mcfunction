...
function kboss:system/each_boss/martellos/pose/push/2
...
tag @e[distance=..16,tag=KB.AI,tag=KB.LeftArm2,tag=KB.BossCheck] add KB.Attack
tag @e[distance=..16,tag=KB.AI,tag=KB.RightArm2,tag=KB.BossCheck] add KB.Attack
