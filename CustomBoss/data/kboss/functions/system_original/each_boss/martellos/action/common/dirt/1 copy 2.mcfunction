...
function kboss:system/each_boss/platypus/action/commmon/player_direction/is_backside
...
summon minecraft:armor_stand ~ ~-3 ~ {Glowing:1b,Invisible:1b,NoGravity:1b,Tags:["KB.Child","KB.Dirt","KB.BulletSkin","KB.NewSummoned"],ArmorItems:[{},{},{},{id:"minecraft:dirt",Count:1b,tag:{CustomModelData:1}}],Passengers:[{id:"minecraft:slime",Size:1,Silent:1b,ActiveEffects:[{Ambient:0b,ShowParticles:0b,Duration:2147483647,Id:14b,Amplifier:0b}],Invulnerable:1b,Tags:["KB.Child","KB.Dirt","KB.Bullet","KB.NewSummoned"],DeathLootTable:"minecraft:empty"}]}
