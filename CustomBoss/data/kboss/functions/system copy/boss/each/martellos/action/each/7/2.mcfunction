...
execute if score @s kb.action_time matches 10 if entity @a[distance=..4] if predicate kboss:random/200m run function kboss:system/boss/each/martellos/action/each/26/start
