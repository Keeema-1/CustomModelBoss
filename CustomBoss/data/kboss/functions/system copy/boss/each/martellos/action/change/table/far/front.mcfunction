...
# 7:叩く(右)
execute if score @s kb.temp matches 0 run function kboss:system/boss/each/martellos/action/change/7
# 8:叩く(左)
...
# 14:回転(右)
execute if score @s kb.temp matches 2 run function kboss:system/boss/each/martellos/action/change/14
# 15:回転(左)
execute if score @s kb.temp matches 3 run function kboss:system/boss/each/martellos/action/change/15
# 16:揺らす
#execute if score @s kb.temp matches 9..10 run function kboss:system/boss/each/martellos/action/change/16
# 17:突進
execute if score @s kb.temp matches 4..8 run function kboss:system/boss/each/martellos/action/change/17
# 18:小突く
#execute if score @s kb.temp matches 12..13 run function kboss:system/boss/each/martellos/action/change/18
# 19:回転土飛ばし(右)
execute if score @s kb.temp matches 9..11 run function kboss:system/boss/each/martellos/action/change/19
# 20:回転土飛ばし(左)
execute if score @s kb.temp matches 12..14 run function kboss:system/boss/each/martellos/action/change/20
# 23:ジャンプ叩き
execute if score @s kb.temp matches 15 run function kboss:system/boss/each/martellos/action/change/23
