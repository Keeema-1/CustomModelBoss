...
# 8:叩く(左)
execute if score @s kb.temp matches 4..6 run function kboss:system/boss/each/martellos/action/each/8/start
# 9:叩く(尻尾)
...
# 14:回転(右)
execute if score @s kb.temp matches 9..10 run function kboss:system/boss/each/martellos/action/each/14/start
# 15:回転(左)
...
# 18:小突く
#execute if score @s kb.temp matches 11..13 run function kboss:system/boss/each/martellos/action/each/1/start8
# 19:回転土飛ばし(右)
