...
# 9:叩く(尻尾)
execute if score @s kb.temp matches ..7 run function kboss:system/boss/each/martellos/action/change/9
# 10:ステップ(右)
...
# 12:タックル(右)
execute if score @s kb.temp matches 8 run function kboss:system/boss/each/martellos/action/change/12
# 13:タックル(左)
