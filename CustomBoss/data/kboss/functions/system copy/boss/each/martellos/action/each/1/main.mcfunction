...
execute if score @s kb.action_time matches 1.. if entity @a[distance=8..16] if predicate kboss:random/50m run function kboss:system/boss/each/martellos/action/change/23
