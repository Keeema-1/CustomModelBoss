...
execute if predicate kboss:random/200m positioned ^ ^1 ^-3 run function kboss:system/boss/each/martellos/action/common/dirt/1

execute if score @s kb.action_time matches ..0 run function kboss:system/boss/each/martellos/action/each/20/3to4
