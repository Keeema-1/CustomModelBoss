...
execute if score @s kb.anime_time matches 105 run function kboss:system/boss/each/platypus/pose/tail/left/5
...
execute if score @s kb.anime_time matches ..0 run function kboss:system/boss/each/platypus/action/101/2to3
