...
# 8:叩く(左)
execute if score @s kb.temp matches ..4 run function kboss:system/boss/each/martellos/action/each/8/start
# 9:叩く(尻尾)
execute if score @s kb.temp matches 5 run function kboss:system/boss/each/martellos/action/each/9/start
# 10:ステップ(右)
...
# 13:タックル(左)
execute if score @s kb.temp matches 6..9 run function kboss:system/boss/each/martellos/action/each/13/start
# 14:回転(右)
execute if score @s kb.temp matches 10 run function kboss:system/boss/each/martellos/action/each/14/start
# 15:回転(左)
execute if score @s kb.temp matches 11..12 run function kboss:system/boss/each/martellos/action/each/15/start
# 16:揺らす
#execute if score @s kb.temp matches 11..12 run function kboss:system/boss/each/martellos/action/each/16/start
# 17:突進
execute if score @s kb.temp matches 13 run function kboss:system/boss/each/martellos/action/each/17/start
# 18:小突く
...
# 20:回転土飛ばし(左)
execute if score @s kb.temp matches 15 run function kboss:system/boss/each/martellos/action/each/20/start
