...
# 7:叩く(右)
execute if score @s kb.temp matches ..4 run function kboss:system/boss/each/martellos/action/each/7/start
# 8:叩く(左)
...
# 12:タックル(右)
execute if score @s kb.temp matches 6..9 run function kboss:system/boss/each/martellos/action/each/12/start
# 13:タックル(左)
#execute if score @s kb.temp matches 5..8 run function kboss:system/boss/each/martellos/action/each/13/start
# 14:回転(右)
execute if score @s kb.temp matches 10..11 run function kboss:system/boss/each/martellos/action/each/14/start
# 15:回転(左)
execute if score @s kb.temp matches 12 run function kboss:system/boss/each/martellos/action/each/15/start
# 16:揺らす
