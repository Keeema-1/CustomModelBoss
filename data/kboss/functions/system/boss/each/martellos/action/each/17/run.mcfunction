...
execute if data storage kboss:temp {direction:{leftside:1b}} run tp @s ~ ~ ~ ~-0.75 0
execute if data storage kboss:temp {direction:{leftside:0b}} run tp @s ~ ~ ~ ~0.75 0

function kboss:system/boss/each/common/action/player_direction/is_frontside
