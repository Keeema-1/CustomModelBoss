...
function kboss:system/boss/each/martellos/pose/turn/left/1

scoreboard players set @s kb.action 6
...
#tag @e[distance=..16,tag=KB.HitBox,tag=KB.Body2,tag=KB.BossCheck] add KB.Attack
