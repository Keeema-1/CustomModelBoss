...
tag @e[distance=..16,tag=KB.LeftArm2,tag=KB.HitBox,tag=KB.BossCheck] add KB.ReachAdd1
tag @e[distance=..16,tag=KB.LeftArm2,tag=KB.HitBox,tag=KB.BossCheck] add KB.Attack
