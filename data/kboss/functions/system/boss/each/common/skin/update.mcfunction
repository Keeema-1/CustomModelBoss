...
execute if score @s kb.rz_global matches 181.. run function kboss:system/boss/each/common/skin/z_remove
execute if score @s kb.rz_global matches ..-181 run function kboss:system/boss/each/common/skin/z_add
...
# AECに乗せないパターン
#function kboss:system/boss/each/common/skin/update_sub2
