...
# 消滅タイマー ※プレイヤーがボスの近くにいて、ボスのパーツが不在のとき カウントダウン
scoreboard objectives add kb.disappear_timer dummy

# チーム
team add kb.boss
team modify kb.boss collisionRule pushOwnTeam
team modify kb.boss nametagVisibility never
